...
function MediaSourceFilter() {
  ...
  const methods = useForm<MediaSourceFilterFormData>({
    defaultValues: {
      url: "",
      isCSR: false,
      status: {
        id: MediaSourceStatusEnum.NOT_PROCESSED,
      },
    },
  });
  ...
  const id = open ? "mediaSource-filter-popover" : undefined;
          ...
          >
            <Grid container spacing={2} mb={3} mt={3}>
              <Grid item xs={12}>
                ...
                <FormSelectInput<
                  MediaSourceFilterFormData,
                  Pick<MediaSourceStatusSelect, "id">
                >
                  name="status"
                  testId="status"
...
export default MediaSourceFilter;
